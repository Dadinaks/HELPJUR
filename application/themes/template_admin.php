				        ...
				        <ul class="navbar-nav nav-flex-icons">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-default" aria-labelledby="dropdown_utilisateur">
                                    ...
                                    <a href="<?php echo base_url('Lieu'); ?>" class="dropdown-item <?php if ($this->uri->segment(1) == "Lieu") { echo "active"; } ?>">
                                        <span class="<?php if ($this->uri->segment(1) == "Lieu") { echo "white-text"; } ?>"><i class="fas fa-hotel mr-2"></i>Gérer les agences</span>
                                    </a>
