...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 18 juin 2020 à 13:01
...
(4,'RALAIVAO','Valérie',5009,'hantanirina.razafindrakoto@bni.mg',99,'DRJC-JCSF','Juridique','Directeur Juridique','Activé',1),
(5,'RAKOTONIRINA','Miora',4152,'hantanirina.razafindrakoto@bni.mg',99,'DRJC-JCSF','Juridique','Juriste Senior','Activé',2),
(6,'RAKOTONARIVO','Hery Michel',4694,'hantanirina.razafindrakoto@bni.mg',99,'DRJC-JCSF','Juridique','Juriste Senior','Activé',2),
(7,'Demandeur1','Demandeur11',1111,'hantanirina.razafindrakoto@bni.mg',5,'Demande','Demande','Demande','Activé',4),
(8,'RAKOTO','SAONA',4338,'hantanirina.razafindrakoto@bni.mg',2,'DMPP','DMPP','Chargé Clientèle','Activé',6),
(9,'RABEARY','Hantanirina',4865,'hantanirina.razafindrakoto@bni.mg',99,'DJUR','JUR','Juriste Junior','Activé',3),
(10,'ddddfgdfgfd','Demandeur1fdgdfg',0,'jkhklk@xx.mg',99,'poidgfdfg','^lmkml','fhgfhgfh','Désactivé',6),
(11,'jhlkjlkj','qsd',1212,'hantanirina.razafindrakoto@bni.mg',1,'Demande','Demande','Demande','Activé',3),
(12,'Rakoto','Be',2222,'hantanirina.razafindrakoto@bni.mg',99,'DMPP','DMPP','Resp','Activé',6);
--
